...
function insertAdmins(name, title, salary, division, location, hire_year){
    db.employees.insert({Name:name, Title:title, Salary:salary, Division:division, Location:location, Hire_Year:hire_year})
...
```{r}
# could not get the R code to work. I cant seem to get the JSON query right
# json_qry <-
#  '{
#    "Title": 
#      {"$regex":"/'PROFESSOR'/i"},
...
db.employees.find({Department:{$ne:'Physics'}, Title: { $regex: /PROFESSOR/i }})
